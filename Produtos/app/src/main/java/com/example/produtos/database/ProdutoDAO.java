...
import com.example.produtos.database.entity.ProdutoEntity;
...
public class ProdutoDAO {
    ...
    public boolean excluir(int id){
        return dbGateway.getDatabase().delete(ProdutoEntity.TABLE_NAME, ProdutoEntity._ID + "=?", new String[]{String.valueOf(id)}) > 0;
    }
